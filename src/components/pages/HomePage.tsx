...
export default function Home() {
  return (
    <main className="relative isolate flex min-h-[calc(100vh-(--spacing(16)))] flex-col items-center justify-center px-4 py-10 text-center sm:px-6 lg:px-8">
      {/* Subtle grid background */}
      <div
        aria-hidden="true"
        className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-primary/5 via-transparent to-transparent"
      />
      ...
      <div className="mt-12 grid w-full max-w-4xl gap-6 md:grid-cols-2">
        ...
        <Card className="group flex flex-col items-center justify-between rounded-2xl border border-border bg-background p-6 shadow transition duration-300 ease-in-out hover:-translate-y-1 hover:shadow-lg">
          ...
          <CardFooter className="pt-4 w-full">
            ...
            >
              <a href="/sharetext">Get Started</a>
            </Button>
          </CardFooter>
        </Card>
      </div>
